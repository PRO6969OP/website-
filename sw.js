...
var e = Object.defineProperty,
    ...
    c = (e, t) => {
        ...
        if (a)
            for (var s of a(t)) r.call(t, s) && i(e, s, t[s]);
        return e
    },
    o = (e, a) => t(e, s(a));
try {
...
function m(e) {
    if (!e) throw new l("add-to-cache-list-unexpected-type", {
        entry: e
    });
    if ("string" == typeof e) {
...
async function R(e, t) {
    ...
    if (s !== self.location.origin) throw new l("cross-origin-copy-response", {
        origin: s
    });
    const a = e.clone(),
        n = {
...
class T {
    constructor(e, t) {
        this._cacheKeys = {}, Object.assign(this, t), this.event = t.event, this._strategy = e, this._handlerDeferred = new C, this._extendLifetimePromises = [], this._plugins = [...e.plugins], this._pluginStateMap = new Map;
    ...
    async cacheMatch(e) {
        ...
        const {
            cacheName: a,
            matchOptions: n
        } = this._strategy, r = await this.getCacheKey(t, "read"), i = c(c({}, n), {
            cacheName: a
        });
    ...
    async cachePut(e, t) {
        ...
        const {
            cacheName: h,
            matchOptions: u
        } = this._strategy, d = await self.caches.open(h), p = this.hasCallback("cacheDidUpdate"), f = p ? await async function(e, t, s, a) {
            const n = x(t.url, s);
            ...
            const r = o(c({}, a), {
                ...
                i = await e.keys(t, r);
            for (const c of i)
                if (n === x(c.url, s)) return e.match(c, a)
        }(d, n.clone(), ["__WB_REVISION__"], u) : null;
        try {
            await d.put(n, p ? i.clone() : i)
        } catch (w) {
            throw "QuotaExceededError" === w.name && await async function() {
                for (const e of U) await e()
            }(), w
        }
        for (const c of this.iterateCallbacks("cacheDidUpdate")) await c({
            cacheName: h,
            oldResponse: f,
            newResponse: i.clone(),
            request: n,
    ...
    async getCacheKey(e, t) {
        if (!this._cacheKeys[t]) {
            let s = e;
            for (const e of this.iterateCallbacks("cacheKeyWillBeUsed")) s = q(await e({
                mode: t,
                request: s,
                event: this.event,
                params: this.params
...
class k {
    constructor(e = {}) {
        this.cacheName = w(e.cacheName), this.plugins = e.plugins || [], this.fetchOptions = e.fetchOptions, this.matchOptions = e.matchOptions
    }
    handle(e) {
    ...
    async _getResponse(e, t, s) {
        ...
        try {
            if (a = await this._handle(t, e), !a || "error" === a.type) throw new l("no-response", {
                url: t.url
            })
        } catch (n) {
...
class E extends k {
    constructor(e = {}) {
        e.cacheName = f(e.cacheName), super(e), this._fallbackToNetwork = !1 !== e.fallbackToNetwork, this.plugins.push(E.copyRedirectedCacheableResponsesPlugin)
    }
    async _handle(e, t) {
    ...
    async _handleFetch(e, t) {
        let s;
        if (!this._fallbackToNetwork) throw new l("missing-precache-entry", {
    ...
    _useDefaultCacheabilityPluginIfNeeded() {
        let e = null,
            t = 0;
        for (const [s, a] of this.plugins.entries()) a !== E.copyRedirectedCacheableResponsesPlugin && (a === E.defaultPrecacheCacheabilityPlugin && (e = s), a.cacheWillUpdate && t++);
        0 === t ? this.plugins.push(E.defaultPrecacheCacheabilityPlugin) : t > 1 && null !== e && this.plugins.splice(e, 1)
    }
}
...
class L {
    constructor({
        ...
        this._urlsToCacheKeys = new Map, this._urlsToCacheModes = new Map, this._cacheKeysToIntegrities = new Map, this._strategy = new E({
            cacheName: f(e),
            plugins: [...t, new b({
    ...
    addToCacheList(e) {
        ...
        for (const s of e) {
            ...
            const {
                cacheKey: e,
                url: a
            } = m(s), n = "string" != typeof s && s.revision ? "reload" : "default";
            if (this._urlsToCacheKeys.has(a) && this._urlsToCacheKeys.get(a) !== e) throw new l("add-to-cache-list-conflicting-entries", {
                firstEntry: this._urlsToCacheKeys.get(a),
                secondEntry: e
            });
            if ("string" != typeof s && s.integrity) {
                if (this._cacheKeysToIntegrities.has(e) && this._cacheKeysToIntegrities.get(e) !== s.integrity) throw new l("add-to-cache-list-conflicting-integrities", {
                    url: a
                });
    ...
    createHandlerBoundToURL(e) {
        ...
        return s => (s.request = new Request(e), s.params = c({
            cacheKey: t
...
function D(e, t, s) {
    ...
    else if ("function" == typeof e) a = new O(e, t, s);
    else {
        if (!(e instanceof O)) throw new l("unsupported-route-type", {
...
class H {
    constructor(e, t, {
        ...
        this._db = null, this._name = e, this._version = t, this._onupgradeneeded = s, this._onversionchange = a || (() => this.close())
    }
    get db() {
        return this._db
    }
    async open() {
        if (!this._db) return this._db = await new Promise(((e, t) => {
            ...
            a.onerror = () => t(a.error), a.onupgradeneeded = e => {
                s ? (a.transaction.abort(), a.result.close()) : "function" == typeof this._onupgradeneeded && this._onupgradeneeded(e)
            }, a.onsuccess = () => {
                const t = a.result;
    ...
    async transaction(e, t, s) {
        return await this.open(), await new Promise(((a, n) => {
...
for (const [_, te] of Object.entries(F))
    for (const e of te) e in IDBObjectStore.prototype && (H.prototype[e] = async function(t, ...s) {
...
class G {
    constructor(e) {
        this._cacheName = e, this._db = new H("workbox-expiration", 1, {
    ...
    async expireEntries(e, t) {
        const s = await this._db.transaction("cache-entries", "readwrite", ((s, a) => {
                ...
                n.onsuccess = () => {
                    ...
                    if (s) {
                        const a = s.value;
                        a.cacheName === this._cacheName && (e && a.timestamp < e || t && i >= t ? r.push(s.value) : i++), s.continue()
                    } else a(r)
                }
            })),
            a = [];
...
class $ {
    constructor(e, t = {}) {
        this._isRunning = !1, this._rerunRequested = !1, this._maxEntries = t.maxEntries, this._maxAgeSeconds = t.maxAgeSeconds, this._matchOptions = t.matchOptions, this._cacheName = e, this._timestampModel = new G(e)
    }
    async expireEntries() {
...
class V {
    constructor(e = {}) {
        ...
        }, this._config = e, this._maxAgeSeconds = e.maxAgeSeconds, this._cacheExpirations = new Map, e.purgeOnQuotaError && (t = () => this.deleteCacheAndMetadata(), U.add(t))
    }
    _getCacheExpiration(e) {
        if (e === w()) throw new l("expire-custom-caches-only");
...
p({
        ...
        precache: "precache",
        runtime: "runtime"
    }), caches.delete("djs-precache-v1"), caches.delete("djs-cdn-v1"), caches.delete("djs-external-v1"), caches.delete("djs-docs-v1"),
    function(e) {
        P().precache(e)
    }([{
        "revision": "1192e445263145783af747f8c3e4a1a3",
        "url": "assets/[...all].10ac8d29.js"
    }, {
        "revision": "3daa89a40a51671c07008ebd0c51828c",
        "url": "assets/[class].32241939.css"
    }, {
        "revision": "205b0a00b132e1102190f0cc01b7528b",
        "url": "assets/[class].bad92a5f.js"
    }, {
        "revision": "8452815de32eeda278914f9f9822ccc6",
        "url": "assets/[file].1fa9f096.js"
    }, {
        "revision": "0dcee84ce6f26b627fdfe843b2d10fc3",
        "url": "assets/[typedef].a1bfcf4e.js"
    }, {
        "revision": "b00bf1641f3fc9c15af0eed266cb89ee",
        "url": "assets/chevron-down.0702575c.js"
    }, {
        "revision": "09903355ed49e847125c52f80d86ab91",
        "url": "assets/docs.28afcded.css"
    }, {
        "revision": "ed80523234d41bc7e066af0019039259",
        "url": "assets/docs.35da277f.js"
    }, {
        "revision": "ee39bc531879b35821b160d82778fc7e",
        "url": "assets/headlessui.esm.0ae1a725.js"
    }, {
        "revision": "e34a337f5dfd9eb86a0b5ce673bcf518",
        "url": "assets/index.a457e4d5.css"
    }, {
        "revision": "34016e5f584a0d52ee6ecaecc33617bf",
        "url": "assets/index.aace49a3.js"
    }, {
        "revision": "85318940f0219997c7e2b0fb96a835ee",
        "url": "assets/search.055dc457.css"
    }, {
        "revision": "3527e37f9bd325930b999b6b37004b21",
        "url": "assets/search.af910521.js"
    }, {
        "revision": "c5285ee4dd781ac777a453e439d5f0cb",
        "url": "assets/See.vue_vue&type=script&setup=true&lang.4bc4719f.js"
    }, {
        "revision": "43521ec5c448d0cf3d04cf45d245a1c0",
        "url": "assets/See.vue_vue&type=script&setup=true&lang.9c59f874.css"
    }, {
        "revision": "57d1b530febbaf438f8ad87ef4d096dc",
        "url": "assets/SourceButton.vue_vue&type=script&setup=true&lang.1b17124c.js"
    }, {
        "revision": "64b155d58ec6b432265a26b3479d2be7",
        "url": "assets/vendor.21010a09.js"
    }, {
        "revision": "d1a7386b55a2cfd0ebb1221f0f827f1f",
        "url": "index.html"
    }]),
    function(e) {
        const t = P();
        D(new I(t, e))
    }(z), self.addEventListener("activate", (e => {
        const t = f();
    ...
    plugins: [new V({
        ...
        constructor(e) {
            this.cacheWillUpdate = async ({
                response: e
            }) => this._cacheableResponse.isResponseCacheable(e) ? e : null, this._cacheableResponse = new J(e)
        }
    }({
        statuses: [0, 200]
    })]
...
var Z;
Z = e => "GET" === e.request.method ? Y.handle(e) : fetch(e.request), j().setDefaultHandler(Z), D(/^https:\/\/raw\.githubusercontent\.com\/discordjs\/.*\.json/i, new class extends k {
    constructor(e = {}) {
...
})), D(/^.*\\.(png|jpg|jpeg|gif|svg|ico)/i, new class extends k {
    async _handle(e, t) {
